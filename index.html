...
<html lang="en">
    ...
    <body bgcolor="#ffffff">
    <center>
        <h1 style="font-family: Helvetica;color: black;">ESP12E NodeMCU Illumination Sensor From PHP API</h1>
    </center>
	<div class="center">
	   <div align="center" class="form">
           <br><br>
            <p style = 'line-height: 60px;font-family: Helvetica;color: #fff;font-size: 50px;' id="luxx">
 ...
 -->
	...
	<script>
		...
		function loaddata(){
				var url = "https://tugasluxmeter.000webhostapp.com/api/read_all.php";
				$.getJSON(url, function(data) {
                    var val= data;
                  var lux=(data['weather'][(Object.keys(data['weather']).length)-1]['lux']);
                   ...
                   document.getElementById("luxx").innerHTML = "<img src = 'sun.png' height=\"60px\" width=\"60px\" style='vertical-align: middle' />  "+lux + "lux";
					console.log(data['data_lux'][(Object.keys(data['data_lux']).length)-1]['lux']);
